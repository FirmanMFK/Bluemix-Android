...
public class MainActivity extends Activity {
    ...
    String MyURL = "https://uwacoding.mybluemix.net";
    String MyAppID = "088c7c6d-5fcf-4c72-b318-6a58acec331d";
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        bmsClient = BMSClient.getInstance();
        bmsClient.initialize(this, BMSClient.REGION_US_SOUTH);
        // Init UI
        initListView();
        initSwipeRefresh();
        // Must create and set default MCA Auth Manager in order for the delete endpoint to work. This is new in core version 2.0.
        MCAAuthorizationManager MCAAuthMan = MCAAuthorizationManager.createInstance(this, MyAppID);
    ...
    private void initListView() {
        ...
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(android.widget.AdapterView<?> parent, View view, int position, long id) {
                ...
                Request request = new Request(MyURL + "/api/Items/" + todoId, Request.DELETE);
    ...
    private void loadList() {
        ...
        Request request = new Request(MyURL+"/api/Items", Request.GET);
        request.send(getApplicationContext(), new ResponseListener() {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!name.isEmpty()) {
                    ...
                    Request request = new Request(MyURL + "/api/Items", Request.POST);
        ...
        editDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!updatedName.isEmpty()) {
                    ...
                    Request request = new Request(MyURL + "/api/Items", Request.PUT);
                    HashMap headers = new HashMap();
                    List<String> contentType = new ArrayList<>();
                    contentType.add("application/json");
                    List<String> accept = new ArrayList<>();
